...
module.exports = function(RED) {
    ...
    function NbrGetVariableNode(config) {
        ...
        node.on('input', function(msg,send,done) {
			...
			var t = {user:"admin",module:"System",action:"GETVARIABLE",variable:"",waitbefore:500,waitafter:500};
			if (node.variable != "")
			...
			ws.onopen = () => {
				...
				msg.payload = "Getting variable "+node.variable;
    ...
    RED.nodes.registerType("nbr-get-variable",NbrGetVariableNode);
}
