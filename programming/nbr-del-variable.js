...
module.exports = function(RED) {
    ...
    function NbrDelVariableNode(config) {
        ...
        node.on('input', function(msg,send,done) {
			node.status({fill:"green",shape:"ring",text:"Removing"});
			//prepare action parameters
			var t = {user:"admin",module:"System",action:"DELVARIABLE",variable:"",waitbefore:500,waitafter:500};
			if (node.variable != "")
			...
			ws.onopen = () => {
				...
				msg.payload = "Removing variable "+node.variable;
    ...
    RED.nodes.registerType("nbr-del-variable",NbrDelVariableNode);
}
