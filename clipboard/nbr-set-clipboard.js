...
module.exports = function(RED) {
    function NbrSetClipboardNode(config) {
        ...
        node.on('input', function(msg,send,done) {
			...
			var t = {user:"admin",module:"Clipboard",action:"SETTEXT",text:"",waitbefore:5000,waitafter:1000};
			t.text = node.text;
			if (node.waitbefore != "")
    ...
    RED.nodes.registerType("nbr-set-clipboard",NbrSetClipboardNode);
}