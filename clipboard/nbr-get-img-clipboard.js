...
module.exports = function(RED) {
    ...
    function NbrGetImgClipboardNode(config) {
        ...
        node.on('input', function(msg,send,done) {
			...
			var t = {user:"admin",module:"Clipboard",action:"GETIMAGE",path:"",waitbefore:500,waitafter:500};
			if (node.path != "")
			    t.path = node.path;
			if (node.waitbefore != "")
    ...
    RED.nodes.registerType("nbr-get-img-clipboard",NbrGetImgClipboardNode);
}